...
public class AbaloneTest {
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("abalone.txt")));
            extractAttributes(attributes, br);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    public static void extractAttributes(double[][][] attributes, BufferedReader br) throws IOException {
